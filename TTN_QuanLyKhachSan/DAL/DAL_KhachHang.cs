...
namespace DAL
{
    public class DAL_KhachHang
    {
        ...
        public bool Them(EC_KhachHang et)
        {
            try
            {
                cn.ThucHienLenh(@"INSERT INTO tblKhachHang (MaKH,TenKH,NgaySinh,GT,SDT,CMND,DiaChi) VALUES ('" + et.MaKH + "',N'" + et.TenKH + "','" + et.NgaySinh + "',N'" + et.GT + "','" + et.SDT + "','" + et.CMND + "',N'" + et.DiaChi + "')");
                return true;
            }
            catch
            {
        ...
        public bool Sua(EC_KhachHang et)
        {
            try
            {
                cn.ThucHienLenh(@"UPDATE tblKhachHang SET TenKH = N'" + et.TenKH + "',NgaySinh = '" + et.NgaySinh + "',GT = N'" + et.GT + "', SDT = '" + et.SDT + "',CMND = '" + et.CMND + "',DiaChi = N'" + et.DiaChi + "' where MaKH = '" + et.MaKH + "'");
                return true;
            }
            catch
            {
